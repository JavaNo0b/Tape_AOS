...
class MainActivity : AppCompatActivity() {
    ...
    private fun toggleFab() {
        ...
        if (isFabOpen) {
            ...
            binding.mainBottomPostBtn.setBackgroundColor(ContextCompat.getColor(this, R.color.navi_unselected))
            ...
            binding.mainBottomPostBtn.setBackgroundColor(ContextCompat.getColor(this, R.color.navi_selected))
        }
